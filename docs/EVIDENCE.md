...
| 当前 `main` Phase 5 | `main@4a3f5cf8` run 32640814960：246 个根测试通过；canonical Nehalem/x86-v2 identity、Phase 5 50/50、evidence 21/21、profile valid | [current main run](https://github.com/cedRiC874/researchops-agent/actions/runs/32640814960)、[当前 main 长期快照](evidence/pilot-telemetry-main-ci-v1/README.md)、[历史门禁审计](evidence/main-offline-gate-20260822/README.md) |
...
| 当前自动化测试 | `main@4a3f5cf8`：根测试 246/246；pilot staging 45 个 offline contracts + 1 个真实 PostgreSQL contract；production slice 18/18 沿用独立历史 main CI，未由该 commit 触发 | [offline run](https://github.com/cedRiC874/researchops-agent/actions/runs/32640814960)、[pilot run](https://github.com/cedRiC874/researchops-agent/actions/runs/32640814963)、[production 历史快照](evidence/production-slice-linux-ci-main-v1/README.md) |
...
| Pilot staging 当前 main 工程证据 | PR #7/#8 regular merged 至 `main@4a3f5cf8`；main run 32640814963 为 45 个 offline contracts + 1 个真实 PostgreSQL contract，无 Provider Key Compose/teardown/final gate 通过 | [当前 main 长期快照](evidence/pilot-telemetry-main-ci-v1/README.md)、[main run](https://github.com/cedRiC874/researchops-agent/actions/runs/32640814963)、[历史 PR #5 快照](evidence/pilot-staging-linux-ci-main-v1/README.md)、[服务验证](../services/pilot_staging/VERIFICATION.md) |
