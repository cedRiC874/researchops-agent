...
| 当前 `main` Phase 5 | `main@9eabf434` run 32844911180：301 个根测试通过；canonical Nehalem/x86-v2 identity、Phase 5 50/50、evidence 21/21、profile valid | [current main run](https://github.com/cedRiC874/researchops-agent/actions/runs/32844911180)、[PR #15/#16 historical main 快照](evidence/eval-v2-anthropic-offline-main-ci-v1/README.md)、[历史门禁审计](evidence/main-offline-gate-20260822/README.md) |
...
| 当前自动化测试 | `main@9eabf434` offline run 32844911180 成功；最近 pilot run 32840171287 与 production run 32840171312 也成功 | [offline run](https://github.com/cedRiC874/researchops-agent/actions/runs/32844911180)、[pilot run](https://github.com/cedRiC874/researchops-agent/actions/runs/32840171287)、[production run](https://github.com/cedRiC874/researchops-agent/actions/runs/32840171312)、[historical 快照](evidence/eval-v2-anthropic-offline-main-ci-v1/README.md) |
...
| Anthropic Models preflight / candidate v4 | 固定 GET preflight 已实现并只用 MockTransport 离线测试；successor branch root/pilot offline contracts 通过；commitment `1741c2b0…f6399c7` predecessor 为 v3，不继承历史结果；generic Anthropic online entrypoints fail closed，未注册、未在线调用 | [Anthropic 边界](ANTHROPIC_PROVIDER.md)、[preflight contract](../evals/v2/anthropic_models_preflight_contract.json)、[candidate v4](../evals/v2/public_regression_candidate_v4.json) |
...
| Pilot staging successor 工程状态 | v5 pack 绑定 candidate v4，任务/翻译/DeepSeek Provider 与 historical v4 pack 相同且未在线运行；v4 pack/review 保持不变 | [服务验证](../services/pilot_staging/VERIFICATION.md)、[historical main 快照](evidence/eval-v2-anthropic-offline-main-ci-v1/README.md)、[历史 telemetry 快照](evidence/pilot-telemetry-main-ci-v1/README.md) |
