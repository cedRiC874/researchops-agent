...
| 当前 `main` Phase 5 | `main@3dfb0a36` run 32932614962：334 个根测试通过；canonical Nehalem/x86-v2 identity、Phase 5 50/50、evidence 21/21、profile valid | [current main run](https://github.com/cedRiC874/researchops-agent/actions/runs/32932614962)、[PR #19 main 快照](evidence/anthropic-models-preflight-main-ci-v1/README.md)、[历史门禁审计](evidence/main-offline-gate-20260822/README.md) |
...
| 当前自动化测试 | `main@3dfb0a36` 的 offline run 32932614962 与 pilot run 32932614805 成功；最近 production run 32930473976 也成功 | [offline run](https://github.com/cedRiC874/researchops-agent/actions/runs/32932614962)、[pilot run](https://github.com/cedRiC874/researchops-agent/actions/runs/32932614805)、[production run](https://github.com/cedRiC874/researchops-agent/actions/runs/32930473976)、[PR #19 main 快照](evidence/anthropic-models-preflight-main-ci-v1/README.md) |
...
| Pilot staging（历史 main CI） | `main@3dfb0a36` pilot run 32932614805 通过 51 项 offline contracts、1 项真实 PostgreSQL contract 与无 Provider secret Compose；该 run 早于 PR #21 candidate v5/supervised v6，不验证该 successor | [main pilot run](https://github.com/cedRiC874/researchops-agent/actions/runs/32932614805)、[pre-call 服务快照](../services/pilot_staging/VERIFICATION.md)、[PR #19 main 快照](evidence/anthropic-models-preflight-main-ci-v1/README.md) |
| Pilot staging candidate v5/v6（PR #21 successor） | PR #21 implementation head `ca0e0380…` 的 offline、pilot 与 production 共 4 条 checks 成功；v6 仍使用 DeepSeek，未运行 Kimi model，且不继承 post-lock metadata receipt 或历史结果。PR disposition/current-head checks 须从 GitHub 实时核验，且不能引用上述历史 main run 作为 v5/v6 main 证据 | [PR #21](https://github.com/cedRiC874/researchops-agent/pull/21)、[pre-call 服务快照](../services/pilot_staging/VERIFICATION.md)、[candidate v5](../evals/v2/public_regression_candidate_v5.json)、[v6 pack](../services/pilot_staging/content/pilot_pack.supervised_v6.json)、[v6 review](../services/pilot_staging/content/pilot_pack.supervised_v6.review.json) |
