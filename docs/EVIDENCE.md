...
| 当前 `main` Phase 5 | `main@77911226` run 32930474006：334 个根测试通过；canonical Nehalem/x86-v2 identity、Phase 5 50/50、evidence 21/21、profile valid | [current main run](https://github.com/cedRiC874/researchops-agent/actions/runs/32930474006)、[PR #19 main 快照](evidence/anthropic-models-preflight-main-ci-v1/README.md)、[历史门禁审计](evidence/main-offline-gate-20260822/README.md) |
...
| 当前自动化测试 | `main@77911226` 的 offline run 32930474006、pilot run 32930473989 与 production run 32930473976 均成功 | [offline run](https://github.com/cedRiC874/researchops-agent/actions/runs/32930474006)、[pilot run](https://github.com/cedRiC874/researchops-agent/actions/runs/32930473989)、[production run](https://github.com/cedRiC874/researchops-agent/actions/runs/32930473976)、[PR #19 main 快照](evidence/anthropic-models-preflight-main-ci-v1/README.md) |
...
| Anthropic Models preflight / candidate v4（已进入 main） | PR #19 regular merged 至 `main@77911226`；固定 GET preflight 只用 MockTransport 离线测试，clean-main root/pilot/production checks 均成功；commitment `1741c2b0…f6399c7` predecessor 为 v3，不继承历史结果；generic Anthropic online entrypoints fail closed，未注册、未在线调用 | [main 长期快照](evidence/anthropic-models-preflight-main-ci-v1/README.md)、[Anthropic 边界](ANTHROPIC_PROVIDER.md)、[preflight contract](../evals/v2/anthropic_models_preflight_contract.json)、[candidate v4](../evals/v2/public_regression_candidate_v4.json) |
...
| Pilot staging candidate v4 工程状态 | `main@77911226` pilot run 32930473989 通过 51 项 offline contracts、1 项真实 PostgreSQL contract 与无 Provider secret Compose；v5 pack 绑定 candidate v4，仍使用 DeepSeek且未在线运行；v4 pack/review 保持不变 | [PR #19 main 快照](evidence/anthropic-models-preflight-main-ci-v1/README.md)、[服务验证](../services/pilot_staging/VERIFICATION.md)、[历史 telemetry 快照](evidence/pilot-telemetry-main-ci-v1/README.md) |
