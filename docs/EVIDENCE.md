...
| 当前 `main` Phase 5 | `main@094cb9b1` run 32648925769：258 个根测试通过；canonical Nehalem/x86-v2 identity、Phase 5 50/50、evidence 21/21、profile valid | [current main run](https://github.com/cedRiC874/researchops-agent/actions/runs/32648925769)、[Completion Telemetry v2 main 快照](evidence/completion-telemetry-v2-main-ci-v1/README.md)、[历史门禁审计](evidence/main-offline-gate-20260822/README.md) |
...
| 当前自动化测试 | `main@094cb9b1`：根测试 258/258；pilot staging 51 个 offline contracts + 1 个真实 PostgreSQL contract；production slice 18/18 + 真实 Compose E2E | [offline run](https://github.com/cedRiC874/researchops-agent/actions/runs/32648925769)、[pilot run](https://github.com/cedRiC874/researchops-agent/actions/runs/32648925679)、[production run](https://github.com/cedRiC874/researchops-agent/actions/runs/32648925726)、[长期快照](evidence/completion-telemetry-v2-main-ci-v1/README.md) |
...
| Pilot staging 当前 main 工程证据 | PR #11 regular merged 至 `main@094cb9b1`；main run 32648925679 为 51 个 offline contracts + 1 个真实 PostgreSQL contract，无 Provider Key Compose/teardown/final gate 通过 | [Completion Telemetry v2 main 快照](evidence/completion-telemetry-v2-main-ci-v1/README.md)、[main run](https://github.com/cedRiC874/researchops-agent/actions/runs/32648925679)、[历史 telemetry 快照](evidence/pilot-telemetry-main-ci-v1/README.md)、[服务验证](../services/pilot_staging/VERIFICATION.md) |
...
| Supervised Completion Telemetry v2（2026-08-25） | 1 completed、0 withdrawn；6/6 terminal，4 feedback，2 个 `provider_output_incomplete` 均安全分类为 `response_output_item_incomplete`；source coverage 2/2，model/tool/backend 为 9/3/2，安全 incidents 0；不主张新独立参与者或 external validation | [脱敏证据](evidence/supervised-completion-telemetry-v2-20260825/README.md)、[aggregate projection](evidence/supervised-completion-telemetry-v2-20260825/aggregate_projection.json)、[故障 001](evidence/supervised-completion-telemetry-v2-20260825/failures/PILOT-CTV2-20260825-001.md)、[故障 002](evidence/supervised-completion-telemetry-v2-20260825/failures/PILOT-CTV2-20260825-002.md) |
