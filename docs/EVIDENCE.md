...
| Supervised 同一参与者 UX regression v2（branch-only） | 1 completed、0 withdrawn；6/6 terminal，4 feedback，2 个 `provider_output_incomplete`；model/tool/backend 计数 9/3/2；telemetry 与 participant projection binding 均 valid；不是第二位独立参与者或 external validation | [脱敏证据](evidence/supervised-ux-regression-v2-20260823/README.md)、[故障 001](evidence/supervised-ux-regression-v2-20260823/failures/PILOT-DIAG-20260823-001.md)、[故障 002](evidence/supervised-ux-regression-v2-20260823/failures/PILOT-DIAG-20260823-002.md)、[PR #8](https://github.com/cedRiC874/researchops-agent/pull/8) |
| Phase 5 hosted-CPU containment（branch-only） | Post-campaign 将离线重建固定到 Nehalem/x86-v2；push/PR 均为 50/50、21/21，pilot CI 通过；仅重绑定硬件敏感 ID/corpus lineage，未改核心源码或 locked candidate | [push run 32639815327](https://github.com/cedRiC874/researchops-agent/actions/runs/32639815327)、[PR run 32639817573](https://github.com/cedRiC874/researchops-agent/actions/runs/32639817573)、[pilot run 32639817571](https://github.com/cedRiC874/researchops-agent/actions/runs/32639817571)、[Phase 5 说明](../evals/README.md) |
