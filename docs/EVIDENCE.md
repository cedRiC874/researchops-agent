...
| 当前 `main` Phase 5 | `main@3e487096` run 32840171286：301 个根测试通过；canonical Nehalem/x86-v2 identity、Phase 5 50/50、evidence 21/21、profile valid | [current main run](https://github.com/cedRiC874/researchops-agent/actions/runs/32840171286)、[PR #15/#16 main 快照](evidence/eval-v2-anthropic-offline-main-ci-v1/README.md)、[历史门禁审计](evidence/main-offline-gate-20260822/README.md) |
...
| 当前自动化测试 | `main@3e487096`：根测试 301/301；pilot staging 51 个 offline contracts + 1 个真实 PostgreSQL contract；production slice 18/18 + 真实 Compose E2E；三个 checks 均成功 | [offline run](https://github.com/cedRiC874/researchops-agent/actions/runs/32840171286)、[pilot run](https://github.com/cedRiC874/researchops-agent/actions/runs/32840171287)、[production run](https://github.com/cedRiC874/researchops-agent/actions/runs/32840171312)、[长期快照](evidence/eval-v2-anthropic-offline-main-ci-v1/README.md) |
...
| Anthropic offline adapter / candidate v3（已进入 main） | PR #16 regular merged；candidate `22c985e9…b2a9` predecessor 为 `1f6ac18e…e5ce5`，不继承历史结果；Anthropic 为 `offline_contract_only`、未注册、未在线调用，public/pilot Provider 仍为 DeepSeek | [PR #15/#16 main 快照](evidence/eval-v2-anthropic-offline-main-ci-v1/README.md)、[Anthropic 边界](ANTHROPIC_PROVIDER.md)、[machine contract](../evals/v2/anthropic_provider_contract.json)、[candidate v3](../evals/v2/public_regression_candidate_v3.json) |
...
| Pilot staging 当前 main 工程证据 | `main@3e487096` run 32840171287 为 51 个 offline contracts + 1 个真实 PostgreSQL contract，无 Provider Key Compose/teardown/final gate 通过；v4 pack 仍为 DeepSeek 且未在线运行 | [PR #15/#16 main 快照](evidence/eval-v2-anthropic-offline-main-ci-v1/README.md)、[main run](https://github.com/cedRiC874/researchops-agent/actions/runs/32840171287)、[历史 telemetry 快照](evidence/pilot-telemetry-main-ci-v1/README.md)、[服务验证](../services/pilot_staging/VERIFICATION.md) |
