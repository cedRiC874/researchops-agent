...
from .campaign_start import ROOT, _ClaimedCampaignStart, _ClaimedCampaignStartV5
...
class _CampaignTaskOwner:
    def __init__(self, prepared):
        if type(self) not in (_CampaignTaskOwner, _CampaignTaskOwnerV5):
            raise CampaignTaskReleaseError('campaign_task_release_preparation_required')
        expected = _ClaimedCampaignStart if type(self) is _CampaignTaskOwner else _ClaimedCampaignStartV5
    ...
    def _check_current(self):
        ...
        if type(self) is _CampaignTaskOwnerV5:
...
class _CampaignTaskOwnerV5(_CampaignTaskOwner):
    """Only the v5 consumed preparation can enter this owner."""
    pass
