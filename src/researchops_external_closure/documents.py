...
def _verify_consumption_timeline(
    documents: Mapping[str, Mapping[str, Any]],
    observation: Mapping[str, Any],
...
def _verify_signed_preregistration_graph(decoded, observation):
...
def verify_pre_receipt_documents(
    ...
    *,
    ...
    trust = _verify_signed_preregistration_graph(decoded, observation)
